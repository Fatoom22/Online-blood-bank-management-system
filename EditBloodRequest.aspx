<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="EditBloodRequest.aspx.cs" Inherits="EditBloodRequest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="RequestID" DataSourceID="SqlDataSource1" GridLines="None" style="font-size: medium" Width="1072px" ForeColor="#333333">
        ...
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="RequestID" DataNavigateUrlFormatString="EditBloodRequest.aspx?id={0}" HeaderText="Delete" Text="Delete" />
        </Columns>
        <EmptyDataTemplate>
            No Request Found
        </EmptyDataTemplate>
