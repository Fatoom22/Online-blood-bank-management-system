<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageDonor.master" AutoEventWireup="true" CodeFile="DonorBlood_Request.aspx.cs" Inherits="DonorBlood_Request" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    </asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h2>Donor View Blood Requests</h2>
